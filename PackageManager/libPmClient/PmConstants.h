...
#if UC_CONSUMER == 1
#define UC_PACKAGE_NAME "cm"
#else
#define UC_PACKAGE_NAME "cm-enterprise"
#endif

#define CLOUD_EVENT_STORAGE_FILENAME                    "cm_event.cache"
#define UC_UPGRADE_EVENT_STORAGE_FILENAME               "cm_upgrade.cache"